<?php
  ...
  $edit="SELECT * FROM tb_jenis_dok where id_jenis_dok = $id";
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="updatejns.php">
                      <input hidden="hidden" name="id" class="form-control" value="<?php echo $id;?>"  />
                      <div class="form-group">
                      <label>jenis</label>
                      <input class="form-control form-control-user" type="text" name="jenis" value="<?php echo $data["jenis_dok"];?>" >
                      </div>
